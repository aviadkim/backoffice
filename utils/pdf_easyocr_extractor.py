...
class PDFEasyOCRExtractor:
    def __init__(self, langs=['en']):
        ...
        self.logger.info("Initializing PDF EasyOCR extractor")
        self.reader = easyocr.Reader(langs)
        self.langs = langs
        
    def _setup_logger(self):
        """Set up and return a logger."""
        logger = logging.getLogger('pdf_easyocr_extractor')
        ...
        # Create file handler
        file_handler = logging.FileHandler('logs/pdf_easyocr_extractor.log')
    ...
    def convert_pdf_to_images(self, pdf_path, dpi=300):
        ...
        Args:
            ...
            dpi (int): DPI for rendering (higher values give better quality but larger images)
